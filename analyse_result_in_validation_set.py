...
os.system(root_path+'/'+"generate_prediction_scores_val_set.py")
os.system(root_path+'/'+"pipelines_predictions_val_set.py")
...
for u1,u2 in thresh_list:
    df_result=pd.read_csv(root_path+'/pipelines/'+f'_val_set_pipelines_predictions_{args.run}_u1_'+str(u1)+'_u2_'+str(u2)+'.csv')
...
stat_result.to_csv(root_path+'/stats/'+f'validation_set_stats_pipelines_predictions_{args.run}'+'.csv')
