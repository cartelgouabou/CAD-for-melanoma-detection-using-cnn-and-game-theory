...
#args.run='run0'
df_result=pd.read_csv(root_path+'/pipelines/'+f'all_predictions_{args.run}.csv')
...
for u1,u2 in thresh_list:
    ...
    df_result_pip.to_csv(root_path+'/pipelines/'+f'pipelines_predictions_{args.run}_u1_'+str(u1)+'_u2_'+str(u2)+'.csv')
